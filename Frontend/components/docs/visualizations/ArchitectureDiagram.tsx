  ...
  return (
    <div className="flex-1 bg-background rounded-xl border border-border flex flex-col overflow-hidden shadow-2xl relative">
      ...
      <div className="p-8 relative z-10 flex flex-col h-full">
        ...
        <div className="mb-8">
          <h3 className="text-xl font-normal text-foreground">Live System Architecture</h3>
        ...
        <div className="flex-1 flex items-center justify-center gap-4">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="w-24 h-24 bg-card border-2 border-border/50 rounded-xl flex items-center justify-center text-muted-foreground shadow-lg">
              <Eye className="w-10 h-10" />
            </div>
            <span className="text-xs font-normal text-muted-foreground text-center">LiDAR<br/>Sensor</span>
          </div>

          <ArrowRight className="w-6 h-6 text-slate-600" />

          <div className="flex flex-col items-center gap-2">
            <div className="w-24 h-24 bg-card border-2 border-sky-800 rounded-xl flex flex-col items-center justify-center text-sky-400 shadow-lg relative overflow-hidden">
              <div className="absolute inset-0 bg-sky-500/10" />
              <Zap className="w-8 h-8 mb-1 relative z-10" />
              <span className="text-[10px] font-normal relative z-10">PointNet++</span>
            </div>
            <span className="text-xs font-normal text-muted-foreground text-center">Semantic<br/>AI</span>
          </div>

          <ArrowRight className="w-6 h-6 text-slate-600" />

          <div className="flex flex-col items-center gap-2">
            <div className="w-24 h-24 bg-card border-2 border-emerald-800 rounded-xl flex flex-col items-center justify-center text-emerald-400 shadow-lg relative overflow-hidden">
              <div className="absolute inset-0 bg-emerald-500/10" />
              <Database className="w-8 h-8 mb-1 relative z-10" />
              <span className="text-[10px] font-normal relative z-10">Adaptive</span>
            </div>
            <span className="text-xs font-normal text-muted-foreground text-center">Foveated<br/>Mapper</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 cursor-pointer group" onClick={() => setShowHex(true)}>
            <div className="w-32 h-32 bg-card border-2 border-primary rounded-xl flex flex-col items-center justify-center text-primary shadow-[0_0_20px_rgba(6,182,212,0.3)] group-hover:bg-primary/10 transition-colors">
              <Binary className="w-10 h-10 mb-2" />
              <span className="text-xs font-normal">Binary Frame</span>
              <span className="text-[10px] text-primary mt-1">Click to inspect</span>
            </div>
            <span className="text-xs font-normal text-muted-foreground text-center">FastAPI<br/>WebSocket</span>
          </div>

          <ArrowRight className="w-6 h-6 text-slate-600" />

          <div className="flex flex-col items-center gap-2">
            <div className="w-24 h-24 bg-card border-2 border-border/50 rounded-xl flex flex-col items-center justify-center text-muted-foreground shadow-lg">
              <MonitorPlay className="w-10 h-10 mb-1" />
              <span className="text-[10px] font-normal">deck.gl</span>
            </div>
            <span className="text-xs font-normal text-muted-foreground text-center">Next.js<br/>Frontend</span>
          </div>
        ...
        <div className="absolute inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-8" onClick={() => setShowHex(false)}>
          <div className="bg-card border border-border/50 rounded-xl shadow-2xl w-full max-w-4xl flex flex-col max-h-full" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex justify-between items-center p-4 border-b border-border">
              <h4 className="text-primary font-normal flex items-center gap-2"><Binary className="w-5 h-5"/> Frame Binary Structure</h4>
            ...
            <div className="p-6 overflow-y-auto flex gap-6">
              ...
              <div className="w-1/3 space-y-4">
                <div className="bg-background p-4 rounded border border-border">
                  <h5 className="text-muted-foreground font-normal text-xs mb-2">HEADER (52 Bytes)</h5>
                ...
                <div className="bg-background p-4 rounded border border-border">
                  <h5 className="text-muted-foreground font-normal text-xs mb-2">PAYLOAD (variable)</h5>
                  <ul className="text-xs font-mono text-muted-foreground/70 space-y-1">
              ...
              <div className="flex-1 bg-background p-4 rounded border border-border overflow-hidden font-mono text-xs leading-relaxed">
                 ...
                 <div className="text-slate-600">
                   ...
                   <span className="text-primary">A8 47 E6 41</span> <span className="text-sky-400">12 AF 00 00</span> 00 00 00 00 00 00 00 00 <br/>
